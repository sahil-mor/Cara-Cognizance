    ...
    if(password !== confirmPassword ){
        ...
        try{
            ...
            const mailOpts = {
                ...
                to : email,
                subject: 'Cara Cognizance | Verify Account',
                text: "Hi," + "\n\n" + 
                "To proceed further with your account verification at Cara , Please use the OTP given below.This OTP is only valid for 60 minutes."
                + "\n\n" + 
                "OTP : " + otp + " \n\n" + 
                "Regards,\n" +
                "Team ,Cara"
